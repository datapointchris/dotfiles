...
See the [LSP Guide](../legacy-docs/2024-10-22-lsp.md) for detailed language server installation instructions.
...
1. Install the language server (see [LSP Guide](../legacy-docs/2024-10-22-lsp.md))
...
See the [Troubleshooting Guide](../../reference/troubleshooting.md) for common issues and solutions.

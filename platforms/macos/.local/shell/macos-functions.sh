...
function lsaero() {
  ...
  echo "  $(color_blue "alt + a/b/d/e/m/s/x/z")      Go to workspace (direct)"
  echo "  $(color_blue "alt + shift + a/b/d/e/m/s/x/z")  Move window to workspace"
  ...
  echo "  $(color_blue "ctrl + alt + shift + ;")     Enter Cmd Mode (join windows)"
  ...
  color_yellow "Cmd Mode (for join windows):"
...
function lskeys() {
  ...
  echo "  $(color_blue "alt + a/b/d/e/m/s/x/z")      Go to workspace"
...
function lsmove() {
  ...
  echo "$(color_yellow "│")  Switch Workspace:    $(color_blue "alt + a/b/d/e/m/s/x/z")                 $(color_yellow "│")"
...
function lssplit() {
  ...
  echo "$(color_yellow "│")  Switch Workspace:    $(color_blue "alt + a/b/d/e/m/s/x/z")                 $(color_yellow "│")"
  echo "$(color_yellow "│")  Join Window:         $(color_blue "Ctrl+Alt+Shift+; then Shift+h/j/k/l")   $(color_yellow "│")"
  color_yellow "└─────────────────────────────────────────────────────────────┘"
  echo "                              $(color_yellow "↓")"
  color_yellow "┌─────────────────────────────────────────────────────────────┐"
  echo "$(color_yellow "│")                          $(color_green "Tmux")                               $(color_yellow "│")"

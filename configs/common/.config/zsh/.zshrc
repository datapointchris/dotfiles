...
# Not $XDG_STATE_HOME, which typos would otherwise default to: these sessions are a
# typing record worth keeping across a rebuild, and $TYPOS_DATA_DIR below names a
# directory that already replicates and backs up. Declared here rather than in the

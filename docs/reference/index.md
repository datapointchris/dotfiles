...
Quick lookup for platform differences, fonts, tools, and support.
...
- :material-link: __[Symlinks Manager](tools/symlinks.md)__

    Dotfile deployment system

- :material-run: __[Task Reference](tools/tasks.md)__
...
- :material-help-circle: __[Troubleshooting](support/troubleshooting.md)__

    Common issues and solutions

- :material-office-building: __[Corporate Setup](support/corporate.md)__

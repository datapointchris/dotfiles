...
- `configs/common/.local/shell/colors.sh` - Color definitions and color functions
- `configs/common/.local/shell/formatting.sh` - Formatting functions (sources colors.sh)
...
```bash
cp configs/common/.local/shell/colors.sh ~/my-project/lib/
cp configs/common/.local/shell/formatting.sh ~/my-project/lib/
```

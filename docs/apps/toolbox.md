...
Tool discovery system for the installed tools in your dotfiles. Find tools by name, category, or purpose. Get usage examples and learn when to use each tool.
